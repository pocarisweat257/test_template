...
2. Transfer ultrasonic sensor data and control results to the Cluster application using inter-domain communication protocol.
...
## Project Timeline
 ...
 4. Week 5-6: Integrate your Cluster application into a virtual machine and run application using various qt plugins (vnc, linuxfb, etc.).
 5. Week 7: Implement a inter-domain communication between Cluster and PDC-System, output sensor data and control results to the cluster.
